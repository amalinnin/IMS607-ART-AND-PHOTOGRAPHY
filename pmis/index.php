...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-container">
    <h3 class="w3-padding-64"><b>Art and Photography<br>UiTMCK</b></h3>
  </div>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    <h1 class="w3-jumbo"><b>Art and Photography's Club UiTMCK</b></h1>
  ...
  <p align="center"><h3>Membership form for Art and Photography Club UiTMCK 2024</h3></p>
    ...
    <div class="w3-col m4 w3-margin-bottom">
      <div class="w3-light-grey">
        <div class="w3-container">
          ...
          <p> Art and Photography participate in mentoring programs where they receive guidance, support, and advice from experienced mentors within the club or external mentors.</p>
        </div>
      </div>
    </div>
    <div class="w3-col m4 w3-margin-bottom">
  ...
  <div class="w3-container" id="packages" style="margin-top:75px">
    ...
    <hr style="width:50px;border:5px solid red" class="w3-round">
    <p>Welcome to the Achievement Section of the Art and Photography' Club! Here, we celebrate the remarkable accomplishments of our members and highlight their outstanding contributions to personal and professional growth.</p>
  </div>
  ...
  <div class="w3-container" id="contact" style="margin-top:75px">
    ...
    <hr style="width:50px;border:5px solid red" class="w3-round">
    <p>"Join our vibrant community of Art and Photography! Elevate your potential and connect with like-minded individuals by becoming a part of our esteemed club today."</p>
