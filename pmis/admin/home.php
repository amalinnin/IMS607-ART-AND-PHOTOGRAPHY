...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-container">
    <h5>Art and Photography UiTMCK</h5>
  </div>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:26px">
    <h5><b><i class="fa fa-dashboard"></i>Welcome to Art and Photography UiTMCK Club</b></h5>
  </header>
    <div class="container">
    <?php
    if (isset($_GET["msg"])) {
  ...
  <p align="center"><h3>Membership form for ANP UiTMCK 2024</h3></p>
